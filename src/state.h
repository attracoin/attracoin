...
const int64_t GENESIS_BLOCK_TIME = 1534326148 ;
...
static const int64_t MAX_MONEY = 5100000000 * COIN;       //  2,100,000,000 AttraCoin Total
static const int64_t COIN_YEAR_REWARD = 0.7 * CENT;         //  6% 1st Year
static const int64_t SCOIN_YEAR_REWARD = 0.7 * CENT;        //  6% 1st halving
static const int64_t CCOIN_YEAR_REWARD = 0.7 * CENT;        //  6% 2nd halving
static const int64_t KCOIN_YEAR_REWARD = 0.7 * CENT;        //  6% 3rd halving
static const int64_t ICOIN_YEAR_REWARD = 0.7 * CENT;        //  6% 4th halving
static const int64_t OCOIN_YEAR_REWARD = 0.7 * CENT;        //  6% 5th halving
static const int64_t DCOIN_YEAR_REWARD = 0.7 * CENT;        //  6% 6th halving
static const int64_t RCOIN_YEAR_REWARD = 0.7 * CENT;        //  6% 7th halving
static const int64_t ECOIN_YEAR_REWARD = 0.7 * CENT;        //  6% 8th halving
static const int64_t ACOIN_YEAR_REWARD = 0.7 * CENT;        //  6% 9th halving
static const int64_t MCOIN_YEAR_REWARD = 0.7 * CENT;        //  6% 10th halving
static const int64_t ZCOIN_YEAR_REWARD = 0.7 * CENT;        //  6% 11th halving and onwards
