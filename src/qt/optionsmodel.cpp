...
void OptionsModel::Init()
{
    ...
    nDisplayUnit = settings.value("nDisplayUnit", BitcoinUnits::ATT).toInt();
	...
	LogPrintf("OptionsModel::Init nReserveBalance = %d.\n", nReserveBalance);  //MBC
    ...
    fAutoRedeemAttraCoin = settings.value("fAutoRedeemAttraCoin", false).toBool();
...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    if(role == Qt::EditRole)
    {
        ...
        case ReserveBalance:
			...
			LogPrintf("OptionsModel::data nReserveBalance = %d.\n", nReserveBalance);  //MBC
        ...
        case AutoRedeemAttraCoin:
            return fAutoRedeemAttraCoin;
        case MinRingSize:
            return nMinRingSize;
        case MaxRingSize:
            return nMaxRingSize;
...
QString OptionsModel::optionIDName(int row)
{
    ...
    case AutoRedeemAttraCoin: return "AutoRedeemAttraCoin";
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case ReserveBalance:
			...
			LogPrintf("OptionsModel::setData nReserveBalance = %d.\n", nReserveBalance);  //MBC
        ...
        case DisplayAddresses:
            ...
            emit displayUnitChanged(settings.value("nDisplayUnit", BitcoinUnits::ATT).toInt());
            break;
        case DetachDatabases: {
        ...
        case AutoRingSize: {
            ...
            break;
        case AutoRedeemAttraCoin: {
            fAutoRedeemAttraCoin = value.toBool();
            settings.setValue("fAutoRedeemAttraCoin", fAutoRedeemAttraCoin);
            }
            break;
        case MinRingSize: {
        ...
        case Staking:
			...
			LogPrintf("OptionsModel::setData Staking = %s \n", value.toBool()?"true":"false" );  //MBC
...
bool OptionsModel::getAutoRedeemAttraCoin() { return fAutoRedeemAttraCoin; }
