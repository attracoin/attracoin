...
/**
  AttraCoin GUI main class. This class represents the main window of the AttraCoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class AttraCoinGUI : public QMainWindow
{
    Q_OBJECT
public:
    explicit AttraCoinGUI(QWidget *parent = 0);
    ~AttraCoinGUI();
