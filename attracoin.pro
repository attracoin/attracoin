...
android {
    ...
    RESOURCES = attracoin.qrc

build_macosx64 {
    QMAKE_TARGET_BUNDLE_PREFIX = co.attracoin
    BOOST_LIB_SUFFIX=-mt
...
HEADERS += \
    ...
    src/qt/attracoingui.h \
    src/qt/attracoinbridge.h \
...
SOURCES += \
    ...
    src/qt/attracoingui.cpp \
    src/qt/attracoin.cpp \
    src/qt/attracoinbridge.cpp \
...
macx:ICON = src/qt/res/icons/attracoin.icns
macx:TARGET = "AttraCoin"
